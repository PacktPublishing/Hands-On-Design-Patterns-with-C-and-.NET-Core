...
*	The principles and model of Reactive programming
*	Reactive IObserver and IObservable
*	Reactive extensions - .NET Rx Extensions
*	Use Case discussion of Inventory application - Get inventory with a filter, paging, sorting

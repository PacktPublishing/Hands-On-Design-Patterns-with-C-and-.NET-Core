...
##	Chapter-4: Implementing Design Patterns - Abstract and Observer Patterns ##
*	Gathering the requirements Implement Logging - Configurable logging level (severity) for Information, Warning, Error, ILogger implementation for the eventlog, ILogger implementation for the filesystem, A failure in the logger should not affect the handling of the inventory system
*	New logging tests
*	Eventlog writer
*	File write
*	Review and running the application
